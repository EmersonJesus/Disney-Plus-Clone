const collectionsModule = () => {
    ...
    const translateSlide = (position) => {
        ...
        state.lastTranslatePostion = position
    ...
    const setArrowButtonsDisplay = () => {
        const {btnNext, btnPrevious, state} = collectionData[currentCollectionIndex]
    ...
    const onMouseDown = (event, itemIndex) => {
        ...
        state.currentSlidePosition = event.clientX - state.lastTranslatePostion
